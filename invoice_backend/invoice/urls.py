...
from .views import TaxListCreateView, TaxDetailView, InvoiceListCreateView, InvoiceDetailView, InvoiceItemListCreateView, InvoiceItemDetailView, FinalInvoiceListCreateView, FinalInvoiceDetailView
